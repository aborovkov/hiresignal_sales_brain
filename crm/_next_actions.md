...
> Working list: who to write / who to reply to next. The lightweight daily driver.
...
- [ ] `vitalii-pustobaev` (Efix) - TRIAL, on hold by decision 07-20: Efix entry runs through Yulia, no direct FU to him. After Yulia's call: thank-you + outcome, then pick up his loops (Calendly discovery call outcome, invite activity, PM-vacancy run 24h/10). Register "ты" - see `accounts/vitalii-pustobaev.md`
