...
* [ ] Confirm pricing model (per-seat / per-candidate-volume / monthly retainer).
* [ ] Working anchor from earlier planning: **~$1,000/month for up to ~100 candidates** — *unconfirmed, verify before quoting.*
